/* Freestanding ctype: ASCII character classification as static-inline helpers
 * so user programs need not link an object file. */
#ifndef MYOS_USER_CTYPE_H
#define MYOS_USER_CTYPE_H
